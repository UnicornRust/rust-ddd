...
use crate::{
    ...
    infrastructure::repositories::postgres_user_repository::PostgresUserRepository, schema::users
};
...
pub async fn register_user_handler (
    ...
    match RegisterUserUseCase::new(repo.into_inner()).execute(input.into_inner()).await {
